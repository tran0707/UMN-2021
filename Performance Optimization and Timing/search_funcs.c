...
////////////////////////////////////////////////////////////////////////////////
// SETUP FUNCTIONS
int *make_sequential_array(int len){
...
// allocate a linked list with data elements 0, 1, 2, ...
list_t *make_sequential_list(int len){
...
// well-balanced
bst_t *make_sequential_tree(int len){
  node_t **arr = malloc(sizeof(node_t*)*len);
  for(int i=0; i<len; i++){
    int *gap = malloc(1024);      // create gaps in malloc'd memory
    arr[i] = malloc(sizeof(node_t));
